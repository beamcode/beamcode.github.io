        ...
        <li className="mb-6 ml-4">
          ...
          <div className="mb-1 flex flex-wrap items-center gap-2">
            ...
            <div className="flex gap-1 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 1372.201 1372.684">
                <path
                  fill="#00979D"
                  stroke="#81C9CB"
                  strokeWidth=".932"
                ...
                <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="-16.3" y1="16.071" x2="1354.901" y2="16.071" gradientTransform="matrix(1 0 0 -1 16.8 702.696)">
                  <stop offset=".117" stopColor="#fff" stopOpacity="0" />
                  <stop offset=".252" stopColor="#c0d1d3" stopOpacity=".153" />
                  <stop offset=".387" stopColor="#91b3b7" stopOpacity=".306" />
                  <stop offset=".52" stopColor="#6d9fa3" stopOpacity=".457" />
                  <stop offset=".65" stopColor="#4d9195" stopOpacity=".604" />
                  <stop offset=".776" stopColor="#30888b" stopOpacity=".746" />
                  <stop offset=".895" stopColor="#148386" stopOpacity=".881" />
                ...
                <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="-16.8" y1="16.071" x2="1355.401" y2="16.071" gradientTransform="matrix(1 0 0 -1 16.8 702.696)">
                  ...
                  <stop offset=".153" stopColor="#c0d1d3" stopOpacity=".153" />
                  <stop offset=".306" stopColor="#91b3b7" stopOpacity=".306" />
                  <stop offset=".457" stopColor="#6d9fa3" stopOpacity=".457" />
                  <stop offset=".604" stopColor="#4d9195" stopOpacity=".604" />
                  <stop offset=".746" stopColor="#30888b" stopOpacity=".746" />
                  <stop offset=".881" stopColor="#148386" stopOpacity=".881" />
                  <stop offset="1" stopColor="#008184" />
                </linearGradient>
                <path
                  opacity=".5"
          ...
          {/* <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            Linux, bash scripting, GNU utils, Nginx, nodeJS.
          </p> */}
        </li>
